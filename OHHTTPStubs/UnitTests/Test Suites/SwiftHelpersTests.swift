...
class SwiftHelpersTests : XCTestCase {
  ...
  func testHasHeaderNamedIsTrue() {
    ...
    let hasHeader = hasHeaderNamed("ArbitraryKey")(req as URLRequest)
  ...
  func testHeaderValueForKeyEqualsIsTrue() {
    ...
    let matchesHeader = hasHeaderNamed("foo", value: "bar")(req as URLRequest)
  ...
  func testHeaderValueForKeyEqualsIsFalse() {
    ...
    let matchesHeader = hasHeaderNamed("foo", value: "baz")(req as URLRequest)
