...
[![Build Status](https://travis-ci.org/AliSoftware/OHHTTPStubs.png?branch=master)](https://travis-ci.org/AliSoftware/OHHTTPStubs) [![Donate](http://www.paypalobjects.com/en_US/i/btn/btn_donate_LG.gif)](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=TRTU3UEWEHV92 "Donate")

----

* [Documentation & Usage Examples](#documentation-usage-examples)
* [Special Considerations](#special-considerations)
  * [Using OHHTTPStubs in your Unit Tests](#using-ohhttpstubs-in-your-unit-tests)
  * [OHHTTPStubs and NSURLSession](#ohhttpstubs-and-nsurlsession)
  * [Known limitations](#known-limitations)
* [Installing in your projects](#installing-in-your-projects)
* [About OHHTTPStubs own Unit Tests](#about-ohhttpstubs-own-unit-tests)
...
Here is a basic usage example of `OHHTTPStubs`:
